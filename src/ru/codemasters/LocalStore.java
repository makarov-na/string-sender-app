...
public class LocalStore extends SQLiteOpenHelper {
	...
	private static final String TABLE_CREATE = "CREATE TABLE " + TABLE_NAME + " (" + TEXT + " TEXT, " + DATE
			+ " TEXT);";

	private static final String serverURL = "serverURL";
	private static final String serverURLSettingsFile = "serverURLSettingsFile";

	SharedPreferences settings;

	LocalStore(Context context) {
		super(context, DATABASE_NAME, null, DATABASE_VERSION);
		settings = context.getSharedPreferences(serverURLSettingsFile, 0);
		;
	}
	...
	public String getServiceURLFromLocalStore() {
		String url = settings.getString(serverURL, "http://127.0.0.1");
